...
<body class="h-screen overflow-hidden bg-brand-bg flex antialiased">
    ...
    <x-merchant.kyc-stepper :active="2" />
    ...
    <main id="main-content" class="flex-1 h-full overflow-y-auto pb-24">
        ...
        <footer id="footer" class="fixed bottom-0 right-0 w-[calc(100%-260px)] bg-white border-t border-brand-border px-12 py-4 z-30">
            <div class="max-w-[900px] mx-auto flex items-center justify-between">
                <a href="{{ route('merchant.kyc.company') }}" class="px-6 py-2.5 border border-brand-dark text-brand-dark bg-white hover:bg-gray-50 font-medium rounded-lg transition-colors duration-200 flex items-center gap-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('merchant.kyc.boardMembers') }}" class="px-8 py-2.5 bg-brand-orange hover:bg-brand-orangeHover text-white font-semibold rounded-lg transition-colors duration-200 flex items-center gap-2">
