...
@section('body')
    ...
    <body class="bg-brand-neutral">
        ...
        <form id="onboarding-form" method="POST"
            ...
            <main id="main-content" class="md:ml-[260px] ml-0 pt-16 pb-20 min-h-screen bg-brand-neutral">
                <div class="mx-auto px-4 sm:px-6 lg:px-20 py-8">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-sm text-gray-500">Configure onboarding by selecting solution, partner, acquirers,
                            payment methods, pricing, and merchant details.</p>
                    </div>
                    ...
                    <div id="form-container" class="space-y-6">
                        ...
                        <section class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-gray-50 border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                                <h2 class="text-sm font-bold text-brand-primary uppercase tracking-wide">1. Core
                                    Configuration</h2>
                                <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-1 rounded">Required
                                    Step</span>
                            </div>
                            <div class="p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <!-- Solution Info Card -->
                                        <div id="solution-info-card"
                                            class="bg-gray-50 border border-gray-200 rounded-md p-4 space-y-4">
                                            <div class="flex items-center justify-between">
                                                <span class="text-xs font-bold text-brand-primary uppercase"
                                                    id="selected-solution-name">Select a solution</span>
                                                <span id="solution-status-badge"
                                                    class="bg-gray-100 text-gray-700 text-xs font-medium px-2 py-0.5 rounded-full">-</span>
                                            </div>
                                            <div class="grid grid-cols-2 gap-4 text-xs">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="bg-gray-100 text-gray-700 text-xs font-medium px-2 py-0.5 rounded"
                                                        id="solution-status-detail">-</span>
                                                </div>
                                                <div>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div id="partner-info-card"
                                            ...
                                            <div class="grid grid-cols-2 gap-4 text-xs">
                                                ...
                                                <div>
                                                    <div class="text-gray-500 mb-1">Status</div>
                                                    <span id="partner-status-badge"
                                                        class="bg-gray-100 text-gray-700 text-xs font-medium px-2 py-0.5 rounded">-</span>
                                                </div>
                                                <div>
                                                    <div class="text-gray-500 mb-1">Referral ID</div>
                                                    <div id="partner-referral" class="font-mono font-medium text-gray-900">-
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <section class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                                <h2 class="text-sm font-bold text-brand-primary uppercase tracking-wide">2. Merchant Details
                                </h2>
                            </div>
                            <div class="p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex">
                                            <div
                                                class="bg-gray-50 border border-r-0 border-gray-300 rounded-l-md px-3 flex items-center text-sm text-gray-600">
                                                https://</div>
                        ...
                        <section class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                                <h2 class="text-sm font-bold text-brand-primary uppercase tracking-wide">3. Operations &
                                    Acquirers</h2>
                            </div>
                            <div class="p-6 space-y-8">
                                ...
                                <div class="border-t border-gray-200 pt-6">
                                            ...
                                            <div data-acquirer-card="{{ $acquirerKey }}"
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-sm text-gray-600">
                                                        {{ $acquirer->description ?? 'Acquirer configuration' }}</p>
                                                </div>
                                                <div class="ml-3">
                                                    <input type="checkbox" name="acquirers[]"
                                                        value="{{ $acquirer->name }}"
                                    ...
                                    <!-- Elavon Requirements -->
                                    <div data-elavon-requirements
                                        class="bg-gray-50 border border-gray-200 rounded-md p-4 mt-4">
                        ...
                        <section class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                                <div>
                                    <h2 class="text-sm font-bold text-brand-primary uppercase tracking-wide mb-1">4.
                                        Pricing & Fees</h2>
                                    <p class="text-xs text-gray-500">Assign pricing or customize fees for this onboarding.
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="w-full text-sm min-w-[640px]">
                                            <thead class="bg-gray-50">
                                                <tr>
                                                    <th
                                                        class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wide">
                                                        Payment Method</th>
                                                    <th
                        ...
                        <section class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                                <h2 class="text-sm font-bold text-brand-primary uppercase tracking-wide">5. Internal Tags &
                                    Notes</h2>
                            </div>
                            <div class="p-6 space-y-4">
                                <div>
                                    ...
                                    <div class="flex flex-wrap gap-2" id="tags-container">
                                        ...
                                        @foreach ($selectedTags as $tag)
                                            <span data-tag
                                                class="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-xs font-medium flex items-center gap-2">
                                                {{ $tag }}
                                                <input type="hidden" name="internal_tags[]"
                                                    value="{{ $tag }}">
                                                <button type="button" data-tag-remove class="hover:text-purple-900"><i
                                                        class="fa-solid fa-xmark text-xs"></i></button>
                                            </span>
                                        @endforeach
                                        <button type="button" id="add-tag-btn"
                                            class="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs font-medium flex items-center gap-2">
                                    ...
                                    <!-- Add Tag Modal -->
                                    <div id="tag-modal"
                                        class="fixed inset-0 bg-black/40 backdrop-blur-[1px] hidden items-center justify-center z-50">
                                        <div class="bg-white w-full max-w-md rounded-xl shadow-xl border border-gray-200">
                                            <div
                                                class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                                                <div class="flex items-center gap-2">
                                                    <span
                                                        class="bg-brand-neutral text-brand-primary px-2 py-1 rounded-md text-xs font-semibold">Tag</span>
                                                    <h3 class="text-sm font-semibold text-gray-900">Add Internal Tag</h3>
                                                </div>
                                                <button type="button" id="tag-modal-close"
                                                    class="text-gray-400 hover:text-gray-600">
                                                    <i class="fa-solid fa-xmark"></i>
                                                </button>
                                            </div>
                                            <div class="px-6 py-5 space-y-3">
                                                <label for="tag-name-input" class="text-xs font-medium text-gray-600">Tag
                                                    name</label>
                                                <input id="tag-name-input" type="text" placeholder="e.g. High-Risk"
                                                    class="w-full h-[40px] px-4 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-brand-secondary" />
                                                <p class="text-[11px] text-gray-400">Tags help categorize onboardings for
                                                    internal review.</p>
                                            </div>
                                            <div
                                                class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-2">
                                                <button type="button" id="tag-modal-cancel"
                                                    class="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-800">Cancel</button>
                                                <button type="button" id="tag-modal-save"
                                                    class="px-4 py-2 text-sm font-medium text-white bg-brand-cta hover:bg-brand-ctaHover rounded-md">Add
                                                    Tag</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="internal_notes" rows="3"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-brand-secondary resize-none"
                                        placeholder="Add internal notes visible only to 2iZii team...">{{ old('internal_notes', $onboarding->internal_notes ?? '') }}</textarea>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                                <h2 class="text-sm font-bold text-brand-primary uppercase tracking-wide">6. System
                                    Information</h2>
                            </div>
                            <div class="p-6">
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                                    <div>
                                        ...
                                        <div class="font-mono text-sm text-gray-900">
                                            {{ $isEdit ? $onboarding->request_id : 'NEW' }}</div>
                                    </div>
                                    <div>
                                        <div class="text-xs text-gray-500 mb-1">Status</div>
                                        <span
                                            class="bg-gray-100 text-gray-700 text-xs font-medium px-2 py-0.5 rounded">{{ $isEdit ? ucfirst($onboarding->status) : 'Draft' }}</span>
                                    </div>
                                    <div>
                                        <div class="text-xs text-gray-500 mb-1">Created On</div>
                                        <div class="font-medium text-sm text-gray-900">
                                            {{ $isEdit ? $onboarding->created_at->format('Y-m-d H:i') : '-' }}</div>
                                    </div>
                                    <div>
                                        <div class="text-xs text-gray-500 mb-1">Created By</div>
                                        <div class="font-medium text-sm text-gray-900">
                                            {{ $isEdit && $onboarding->creator ? $onboarding->creator->name : 'Current User' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if ($isEdit && $onboarding->kyc_link)
                            <section class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                                <div class="bg-gray-50 border-b border-gray-200 px-6 py-4">
                                    <h2 class="text-sm font-bold text-brand-primary uppercase tracking-wide">7. KYC Link
                                        Preview</h2>
                                </div>
                                        ...
                                        <div class="flex items-center gap-3 flex-1">
                                            ...
                                            @if ($isEdit && $onboarding->kyc_link)
                                                <span class="font-mono text-sm text-gray-600"
                                                    id="kyc-link-text">{{ url('/merchant/kyc/' . $onboarding->kyc_link) }}</span>
                                            @else
                                                <span class="font-mono text-sm text-gray-600 italic">Link will be generated
                                                    after sending</span>
                                            @endif
                                        </div>

                                        <button type="button"
                                            class="copy-kyc-link-btn bg-brand-primary text-white px-3 py-1.5 rounded text-sm font-medium flex items-center gap-2 hover:bg-brand-secondary transition-colors"
            ...
            <footer
                class="fixed bottom-0 left-0 md:left-[260px] right-0 bg-white border-t border-gray-200 px-4 md:px-20 py-4 flex justify-between items-center z-30">
                <div class="max-w-[1024px] w-full mx-auto flex flex-col sm:flex-row justify-between items-center gap-3">
                    <a href="{{ route('admin.onboarding.index') }}"
                        class="text-gray-600 hover:text-gray-900 text-sm font-medium w-full sm:w-auto text-center">
                        Cancel
                    </a>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updatePartnerInfo(partnerId) {
                    ...
                    if (data) {
                        ...
                        document.getElementById('partner-status-badge').className =
                ...
                function updateSolutionInfo(solutionId) {
                    ...
                    if (data) {
                        ...
                        document.getElementById('solution-status-badge').className =
                            'bg-gray-100 text-gray-700 text-xs font-medium px-2 py-0.5 rounded-full';
                    }
                }
                ...
                paymentButtons.forEach(btn => {
                    btn.addEventListener('click', function(e) {
                        ...
                        const checkbox = document.querySelector(
                            `[data-payment-method-input="${methodName}"]`);
                        ...
                        if (this.classList.contains('bg-brand-primary')) {
                            this.classList.remove('bg-brand-primary', 'text-white',
                ...
                function addTagFromInput() {
                    ...
                    tagSpan.className =
                        'bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-xs font-medium flex items-center gap-2';
                    tagSpan.innerHTML = `
                        ${tagName}
                ...
                function showCopySuccess(btn) {
                    ...
                    btn.className =
                        'copy-kyc-link-btn bg-green-600 text-white px-3 py-1.5 rounded text-sm font-medium flex items-center gap-2';
