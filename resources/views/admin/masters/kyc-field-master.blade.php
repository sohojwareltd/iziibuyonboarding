...
@section('body')
    ...
    <body class="bg-brand-neutral">
                    ...
                    <div class="max-w-[1200px] mx-auto">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Manage and configure KYC data fields for merchant
                                    onboarding.</p>
                            </div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-t-xl p-4">
                            <form method="GET" action="{{ route('admin.masters.kyc-field-master') }}" class="space-y-4">
                                ...
                                @if (request()->has('search') ||
                                        request()->has('kyc_section') ||
                                        request()->has('data_type') ||
                                        request()->has('sensitivity_level') ||
                                        request()->has('status'))
                                    <div class="active-filters">
                                        ...
                                        @if (request('kyc_section'))
                                            <div class="filter-badge">
                                                ...
                                                <span>Section:
                                                    {{ $kycSections->firstWhere('id', request('kyc_section'))->name ?? request('kyc_section') }}</span>
                                        ...
                                        @if (request('sensitivity_level'))
                                            <div class="filter-badge">
                                                ...
                                                <span>Sensitivity:
                                                    {{ ucfirst(str_replace('-', ' ', request('sensitivity_level'))) }}</span>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-end gap-3">
                                            ...
                                            <select name="kyc_section"
                                                ...
                                                @foreach ($kycSections as $section)
                                                    <option value="{{ $section->id }}"
                                                        {{ request('kyc_section') == $section->id ? 'selected' : '' }}>
                                                        {{ $section->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="filter-group flex-1 w-full sm:w-auto">
                                            ...
                                            <select name="data_type"
                                                ...
                                                <option value="text"
                                                    {{ request('data_type') == 'text' ? 'selected' : '' }}>Text</option>
                                                <option value="date"
                                                    {{ request('data_type') == 'date' ? 'selected' : '' }}>Date</option>
                                                <option value="number"
                                                    {{ request('data_type') == 'number' ? 'selected' : '' }}>Number
                                                </option>
                                                <option value="email"
                                                    {{ request('data_type') == 'email' ? 'selected' : '' }}>Email</option>
                                                <option value="tel"
                                                    {{ request('data_type') == 'tel' ? 'selected' : '' }}>Phone</option>
                                                <option value="url"
                                                    {{ request('data_type') == 'url' ? 'selected' : '' }}>URL</option>
                                                <option value="password"
                                                    {{ request('data_type') == 'password' ? 'selected' : '' }}>Password
                                                </option>
                                                <option value="time"
                                                    {{ request('data_type') == 'time' ? 'selected' : '' }}>Time</option>
                                                <option value="datetime-local"
                                                    {{ request('data_type') == 'datetime-local' ? 'selected' : '' }}>Date &
                                                    Time</option>
                                                <option value="file"
                                                    {{ request('data_type') == 'file' ? 'selected' : '' }}>File Upload
                                                </option>
                                                <option value="dropdown"
                                                    {{ request('data_type') == 'dropdown' ? 'selected' : '' }}>Dropdown
                                                </option>
                                                <option value="multi-select"
                                                    {{ request('data_type') == 'multi-select' ? 'selected' : '' }}>
                                                    Multi-Select</option>
                                                <option value="checkbox"
                                                    {{ request('data_type') == 'checkbox' ? 'selected' : '' }}>Checkbox
                                                </option>
                                                <option value="radio"
                                                    {{ request('data_type') == 'radio' ? 'selected' : '' }}>Radio</option>
                                                <option value="textarea"
                                                    {{ request('data_type') == 'textarea' ? 'selected' : '' }}>Textarea
                                                </option>
                                                <option value="country"
                                                    {{ request('data_type') == 'country' ? 'selected' : '' }}>Country
                                                </option>
                                                <option value="currency"
                                                    {{ request('data_type') == 'currency' ? 'selected' : '' }}>Currency
                                                </option>
                                                <option value="address"
                                                    {{ request('data_type') == 'address' ? 'selected' : '' }}>Address
                                                </option>
                                                <option value="signature"
                                                    {{ request('data_type') == 'signature' ? 'selected' : '' }}>Signature
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="filter-group flex-1 w-full sm:w-auto">
                                            ...
                                            <select name="sensitivity_level"
                                                ...
                                                <option value="normal"
                                                    {{ request('sensitivity_level') == 'normal' ? 'selected' : '' }}>Normal
                                                </option>
                                                <option value="sensitive"
                                                    {{ request('sensitivity_level') == 'sensitive' ? 'selected' : '' }}>
                                                    Sensitive</option>
                                                <option value="highly-sensitive"
                                                    {{ request('sensitivity_level') == 'highly-sensitive' ? 'selected' : '' }}>
                                                    Highly Sensitive</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="flex gap-2 flex-shrink-0 w-full sm:w-auto">
                                            <button type="button"
                                                class="filter-btn-reset !p-2.5 !px-3 flex-1 sm:flex-none"
                                    ...
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th
                                                ...
                                                Status</th>
                                            <th
                                                class="px-6 py-4 text-right text-xs font-bold text-gray-500 uppercase tracking-wider border-b border-gray-200">
                                                Actions</th>
                                        </tr>
                                    </thead>
                                            ...
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                {{-- <td class="px-6 py-4">
                                                    @if ($field->sensitivity_level === 'highly-sensitive')
                                                        <div class="flex items-center gap-1">
                                                            ...
                                                            <span class="text-red-600 text-xs font-medium">Highly
                                                                Sensitive</span>
                                                        </div>
                                                    @elseif($field->sensitivity_level === 'sensitive')
                                                        <div class="flex items-center gap-1">
                                                            <i
                                                                class="fa-solid fa-triangle-exclamation text-yellow-600 text-xs"></i>
                                                            <span
                                                                class="text-yellow-600 text-xs font-medium">Sensitive</span>
                                                        </div>
                                                    @else
                                                ...
                                                <td class="px-6 py-4 text-center">
                                                    <div class="flex items-center justify-center gap-0">
                                                        @if ($field->visible_to_merchant)
                                                            <span
                                                                class="bg-blue-100 border-2 border-white text-blue-700 rounded-full w-6 h-6 flex items-center justify-center text-xs font-medium"
                                                                title="Visible to Merchant">M</span>
                                                        @endif
                                                        @if ($field->visible_to_admin)
                                                            <span
                                                                class="bg-purple-100 border-2 border-white text-purple-700 rounded-full w-6 h-6 flex items-center justify-center text-xs font-medium {{ $field->visible_to_merchant ? '-ml-1' : '' }}"
                                                                title="Visible to Admin">A</span>
                                                        @endif
                                                        @if ($field->visible_to_partner)
                                                            <span
                                                                class="bg-green-100 border-2 border-white text-green-700 rounded-full w-6 h-6 flex items-center justify-center text-xs font-medium -ml-1"
                                                ...
                                                <td class="px-6 py-4">
                                                    ...
                                                    @elseif($field->status === 'draft')
                                                        <span
                                                            class="bg-blue-100 text-blue-700 px-2.5 py-1 rounded-full text-xs font-medium">Draft</span>
                                                    @else
                                                        <span
                                                            class="bg-gray-100 text-gray-700 px-2.5 py-1 rounded-full text-xs font-medium">Inactive</span>
                                                    @endif
                                                </td>
                                                <td class="px-6 py-4 text-right">
                                                    <div class="flex items-center justify-end gap-3">
                                                        <button onclick="editKYCField({{ $field->id }})"
                                                            class="text-gray-400 hover:text-brand-primary transition-colors">
                                                            <i class="fa-solid fa-pen text-sm"></i>
                                                        </button>
                                                        <button
                                                            onclick="deleteKYCField({{ $field->id }}, '{{ $field->field_name }}')"
                    ...
                    <form id="kyc-field-form" class="space-y-8" data-mode="create" data-id="">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-2 pb-2">
                                ...
                                <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wide">Basic Information
                                </h3>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="field-name" name="field_name" class="form-input"
                                    placeholder="e.g. Beneficial Owner Name" required>
                            </div>



                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">KYC Section <span
                                        class="text-red-500">*</span></label>
                                <select id="kyc-section" name="kyc_section_id" class="form-input" required>
                                    <option value="">Select a section</option>
                                    @foreach ($kycSections as $section)
                                        <option value="{{ $section->id }}" data-prefix="{{ str_replace('-', '_', $section->slug) }}">{{ $section->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" id="internal-key" name="internal_key"
                                        class="form-input form-input-with-prefix" placeholder="beneficial_owner_name"
                                        required>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" class="form-input resize-y" rows="3"
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-2 pb-2">
                                ...
                                <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wide">Field Properties
                                </h3>
                            </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-2 pb-2">
                                ...
                                <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wide">Validation Rules
                                </h3>
                            </div>

                            <div class="flex items-center justify-between">
                                <label class="text-sm font-medium text-gray-700">Is Required? <span
                                        class="text-red-500">*</span></label>
                        ...
                        <div class="space-y-4">
                            ...
                            {{-- <div>
                                ...
                                <div class="space-y-2.5">
                                    <label class="flex items-center gap-2.5 cursor-pointer">
                                        <input type="checkbox" id="visible-merchant" name="visible_to_merchant"
                                            value="1" class="w-4 h-4 border-gray-400 rounded text-blue-600">
                                        <span class="text-sm text-gray-700">Visible to Merchant</span>
                                    </label>
                                    <label class="flex items-center gap-2.5 cursor-pointer">
                                        <input type="checkbox" id="visible-admin" name="visible_to_admin" value="1"
                                            class="w-4 h-4 border-gray-400 rounded text-blue-600">
                                        <span class="text-sm text-gray-700">Visible to Admin</span>
                                    </label>
                                    <label class="flex items-center gap-2.5 cursor-pointer">
                                        <input type="checkbox" id="visible-partner" name="visible_to_partner"
                                            value="1" class="w-4 h-4 border-gray-400 rounded">
                            ...
                            <div class="pt-2 border-t border-gray-100">
                                <div class="flex items-center justify-between mb-2">
                                    <label class="block text-sm font-medium text-gray-700">Acquirer wise visibility</label>
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="toggleAllVisibilityAcquirers(true)"
                                            class="text-xs text-brand-secondary font-semibold hover:text-brand-primary">Select All</button>
                                        <button type="button" onclick="toggleAllVisibilityAcquirers(false)"
                                            class="text-xs text-gray-500 font-semibold hover:text-gray-700">Clear</button>
                                    </div>
                                </div>
                                <div class="text-xs text-gray-500 mb-2">If no acquirer selected, field will be visible for all onboarding acquirers.</div>
                                <div class="relative mb-2">
                                    <i class="fa-solid fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-xs"></i>
                                    <input type="text" id="visible-acquirer-search" class="form-input pl-8" placeholder="Search acquirer..." oninput="filterVisibilityAcquirers(this.value)">
                                </div>
                                <div id="visible-acquirer-list" class="max-h-40 overflow-y-auto border border-gray-200 rounded-lg p-2 space-y-1 bg-white">
                                    @foreach ($acquirers as $acquirer)
                                        <label class="visible-acquirer-item flex items-center gap-2 cursor-pointer px-1 py-1 rounded hover:bg-gray-50"
                                            data-search="{{ strtolower($acquirer->name) }}">
                                            <input type="checkbox" name="visible_acquirers[]" value="{{ $acquirer->name }}"
                                                class="w-4 h-4 border-gray-400 rounded text-blue-600 visible-acquirer-checkbox">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-2 pb-2">
                                ...
                                <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wide">System
                                    Configuration</h3>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Sort Order</label>
                                <input type="number" id="sort-order" name="sort_order" class="form-input"
                ...
                <div class="border-t border-gray-200 px-6 py-4 flex items-center justify-between bg-white">
                    ...
                    <div class="flex gap-3">
                        <button type="button" id="save-draft-btn"
                            class="border-2 border-brand-accent text-brand-accent px-5 py-2.5 rounded-lg font-medium hover:bg-orange-50 transition-colors"
                            style="display: none;">
                            Save Draft
                        </button>
                        <button type="button" id="save-field-btn" form="kyc-field-form"
            ...
            <div class="bg-white rounded-xl shadow-2xl max-w-md w-full animate-scale-in">
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-center mb-6">
                        Are you sure you want to delete <span id="delete-field-name"
        ...
        <script>
            ...
            function getSelectedSectionPrefix() {
                const sectionSelect = document.getElementById('kyc-section');
                if (!sectionSelect) {
                    return '';
                }
            ...
            function generateInternalKey(fieldName, sectionPrefix = '') {
                const fieldPart = slugifyKey(fieldName);
                const sectionPart = slugifyKey(sectionPrefix);
                ...
                return `${sectionPart}_${fieldPart}`;
            }

    function setupInternalKeyAutoFill() {
        const fieldNameInput = document.getElementById('field-name');
        const internalKeyInput = document.getElementById('internal-key');
        const sectionSelect = document.getElementById('kyc-section');

        if (!fieldNameInput || !internalKeyInput) {
            return;
        }

        fieldNameInput.addEventListener('input', function() {
            if (!internalKeyAutoMode && internalKeyInput.value.trim() !== '') {
                return;
            }

            internalKeyInput.value = generateInternalKey(fieldNameInput.value, getSelectedSectionPrefix());
        });
        ...
        internalKeyInput.addEventListener('input', function() {
            const suggested = generateInternalKey(fieldNameInput.value, getSelectedSectionPrefix());
            internalKeyAutoMode = this.value.trim() === '' || this.value === suggested;
        });
    }
    ...
    function filterVisibilityAcquirers(searchText) {
        const term = (searchText || '').toLowerCase().trim();
        document.querySelectorAll('.visible-acquirer-item').forEach(item => {
            const haystack = item.dataset.search || '';
            item.style.display = haystack.includes(term) ? '' : 'none';
        });
    }

    function toggleAllVisibilityAcquirers(shouldCheck) {
        document.querySelectorAll('.visible-acquirer-item').forEach(item => {
            if (item.style.display === 'none') {
                return;
            }

            const checkbox = item.querySelector('.visible-acquirer-checkbox');
            if (checkbox) {
                checkbox.checked = shouldCheck;
            }
        });
    ...
    function resetForm() {
        ...
        document.querySelectorAll('.visible-acquirer-checkbox').forEach(chk => {
            chk.checked = false;
        });
        // Reset options
    ...
    const FRIENDLY_FIELD_LABELS = {
        ...
        visible_acquirers: 'Acquirer Visibility',
    ...
    function getFriendlyFieldLabel(fieldPath) {
        ...
        if (root === 'visible_acquirers' && parts.length >= 2) {
            const rowIndex = Number(parts[1]);
            return `Acquirer Visibility (item #${Number.isFinite(rowIndex) ? rowIndex + 1 : '?'})`;
        }
    ...
    function editKYCField(id) {
        fetch(`/admin/masters/kyc-fields/${id}`, {
            ...
            .then(data => {
                ...
                const selectedVisibleAcquirers = Array.isArray(data.visible_acquirers)
                    ? data.visible_acquirers.map(value => String(value).toLowerCase())
                    : [];
                document.querySelectorAll('.visible-acquirer-checkbox').forEach(chk => {
                    chk.checked = selectedVisibleAcquirers.includes(String(chk.value).toLowerCase());
                });

                // Update drawer title
                document.getElementById('drawer-title').textContent = 'Edit KYC Field';
                internalKeyAutoMode = false;
